...
struct book *initialize_lib(struct book *start){
    ...
    new_book1->next=NULL;
    start_lib=new_book1;
    strcpy(new_book1->name,"THE MIND AND ITS CONTROL");
    strcpy(new_book1->author,"SWAMI BUDHANANDA");
    new_book1->id=101;
    ptr=new_book1;

    new_book2=(struct book*)malloc(sizeof(struct book));
    new_book2->next=NULL;
    strcpy(new_book2->name,"A MILLION THOUGHTS");
    strcpy(new_book2->author,"ASTHA ANAND");
    new_book2->id=102;
    ptr->next=new_book2;
    ptr=new_book2;
    ...
    new_book3->next=NULL;
    strcpy(new_book3->name,"BELIEVE IN YOURSELF");
    strcpy(new_book3->author,"DR.JOSEPH MURPHY");
    new_book3->id=103;
    ptr->next=new_book3;
    ptr=new_book3;
    ...
    new_book4->next=NULL;
    strcpy(new_book4->name,"YOU CAN");
    strcpy(new_book4->author,"GEORGE MATTHEW ADAMS");
    new_book4->id=104;
    ptr->next=new_book4;
    ptr=new_book4;
    ...
    new_book5->next=NULL;
    strcpy(new_book5->name,"BE STRONG(FEAR NOT)");
    strcpy(new_book5->author,"SWAMI TATHAGATANANDA");
    new_book5->id=105;
    ptr->next=new_book5;
